...
// ---- KategorieIcons 
$icon_backwaren_salzig_url = '../assets/kategorien/icon_backwaren-salzig.svg';
$icon_backwaren_suess_url = '../assets/kategorien/icon_backwaren-suess.svg';
$icon_gemuese_url = '../assets/kategorien/icon_gemuese.svg';
$icon_konserven_url = '../assets/kategorien/icon_konserven.svg';
$icon_kuehlprodukte_url = '../assets/kategorien/icon_kuehlprodukte.svg';
$icon_obst_url = '../assets/kategorien/icon_obst.svg';
$icon_trockenprodukte_url = '../assets/kategorien/icon_trockenprodukte.svg';
$icon_sonstiges_url = '../assets/kategorien/sonstiges.svg';
                    ...
                    <div class="grid">
                        ...
                        <div class="grid-col-6">
                            <div class="grid-title">
                                ...
                                <!-- OVERLAY -->
                                <a href="/raupeimmersatt">
                                    <img height="22px" src="../assets/icon_help_mini.svg" alt="icon_help" />
                                </a>
                            </div>
                    ...
                    <div class="grid">
                        ...
                        <div class="grid-col-6">
                            ...
                            <div class="rangeslider">
                                <img height="6px" src="../assets/range-thumb-left.svg" alt="range-thumb">
                                <input id="input" type="range" min="1" max="8" value="0" name="haltbarkeit"
                                    class="slider">
                                <img height="6px" src="../assets/range-thumb-right.svg" alt="range-thumb">
                            </div>
